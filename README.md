...
Version 0.4.1. Windows only: capture, mixing, and playback go through WASAPI in the Zig core. The core cross-compiles for Linux and macOS; those backends do not exist yet. The Qt UI is the last Python and is slated for a Zig-native rebuild (see [decision 0011](docs/decisions/0011-zig-native-ui.md)).
