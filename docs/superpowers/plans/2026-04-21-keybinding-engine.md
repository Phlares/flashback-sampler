...
Expected: Prints a path like `C:\Users\Ryon\AppData\Local\flashback-sampler\flashback-sampler` (Windows) or similar.
...
Create `C:\Users\Ryon\.claude\projects\C--Users-Ryon-Documents-dev\memory\project_flashback_keybinding_engine.md` and a pointer in `MEMORY.md`. Content:
