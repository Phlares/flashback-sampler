...
```bash
gh issue view 17 --json body -q .body > C:/Users/user/AppData/Local/Temp/claude/epic17.md
```

Edit that file: `- [ ] d — Mixer` → `- [ ] d — #D Mixer.zig + control-thread writer_active + #41 rider`. Then `gh issue edit 17 --body-file C:/Users/user/AppData/Local/Temp/claude/epic17.md`.
...
gh pr create --base dev --title "feat: Mixer.zig — mixed capture on a Zig thread; control-thread writer_active; #41 engine rider" --body-file C:/Users/user/AppData/Local/Temp/claude/pr-d-body.md
```
